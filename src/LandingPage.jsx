  ...
  return (
    <div className="overflow-hidden bg-black">
      <div className=" min-h-screen bg-black flex flex-col text-white text-center items-center justify-center">
        ...
        <div className=" font-semibold text-2xl sm:text-lg max-sm:text-base p-2 w-1/3  text-slate-700 rounded-3xl group bg-gradient-to-br from-purple-500 to-pink-500 group-hover:from-purple-500 group-hover:to-pink-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800">
